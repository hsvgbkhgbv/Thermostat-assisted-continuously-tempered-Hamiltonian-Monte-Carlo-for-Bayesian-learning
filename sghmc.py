    ...
    def update(self):
        for name, module in self.model._modules.items():
            if self.pattern1.match(name):
                ...
                module.v_w.add_(- dw * module.eta - module.a * module.v_w + module.n_w.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
                module.v_b.add_(- db * module.eta - module.a * module.v_b + module.n_b.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
                w.add_(module.v_w)
                b.add_(module.v_b)
            elif self.pattern2.match(name):
                ...
                module.v_wih.add_(- dwih * module.eta - module.a * module.v_wih + module.n_wih.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
                module.v_bih.add_(- dbih * module.eta - module.a * module.v_bih + module.n_bih.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
                module.v_whh.add_(- dwhh * module.eta - module.a * module.v_whh + module.n_whh.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
                module.v_bhh.add_(- dbhh * module.eta - module.a * module.v_bhh + module.n_bhh.normal_() * (2 * module.a * module.eta / self.N).sqrt_())
